...
class NotificationInbox extends Table
    with TableInfo<NotificationInbox, NotificationInboxData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  NotificationInbox(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  NotificationInboxData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  NotificationInbox createAlias(String alias) {
    return NotificationInbox(attachedDatabase, alias);
  }
...
class NotificationInboxData extends DataClass
    implements Insertable<NotificationInboxData> {
  final String id;
  ...
  factory NotificationInboxData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  NotificationInboxData copyWith({
    String? id,
  ...
  NotificationInboxData copyWithCompanion(NotificationInboxCompanion data) {
    return NotificationInboxData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('NotificationInboxData(')
          ..write('id: $id, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is NotificationInboxData &&
          other.id == this.id &&
...
class NotificationInboxCompanion
    extends UpdateCompanion<NotificationInboxData> {
  final Value<String> id;
  ...
  NotificationInboxCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<NotificationInboxData> custom({
    Expression<String>? id,
